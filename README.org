...
** Common configuration
   ...
   - ~SCOROPTIONS~  - Options passed to scoring plugin during normalization.
...
** Future enhancements
   ...
   It would be nice to allow for different scoring methods with [[https://setuptools.readthedocs.io/en/latest/userguide/entry_point.html][Python plugins]].
